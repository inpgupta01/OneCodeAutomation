...
def main_function(arg):
    ...
    print("###########TEST CASE STARTED FOR LR " + str(lr[1]) + "############################\n\n")
    fail_per_lr = 0
    ...
    for ep in final_list:
        print("Endpoint " + str(ep) + " is connecting to VMR " + str(int(vmr[1])) + " at line rate " + str(
            int(lr[1])) + " kbps.")
        calling(ep, int(vmr[1]), int(lr[1]))
        time.sleep(3)
    ...
    validation_result, error_list = validation(final_list, lr[1], arg, error_list)
    ...
    if fail_per_lr == 0:
        ...
        print("\n\n#################################################################")
        print("\nOver All Test Result for " + str(lr[1]) + " GS Test : PASS\n")
        print("#################################################################")
        exit(0)
    else:
        print("#################################################################")
        print("Over All Test Result for " + str(lr[1]) + " GS Test : FAIL\n")
        print("#################################################################")
        exit(1)
